...
from .env import SILAUTO_URL, SILNLP_ROOT, CUDA_DEVICE, USFM2PDF_PATH, SILNLP_EXPERIMENTS_ROOT
...
class TaskExecutor:
    ...
    def _generate_translate_script(
        ...
        usfm_generate_script = f"""
        # Try to generate PDFs for the drafts, but ignore any failure
        cd $USFM2PDF_PATH
        python main.py -n --header 'AI Draft' '{SILNLP_EXPERIMENTS_ROOT}{experiment_name}/infer/*/{source_project_id}/*.SFM'""" if USFM2PDF_PATH else ""
